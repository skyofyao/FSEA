...
class FRCNN(object):
    ...
    def __init__(self, **kwargs):
        ...
        #self.colors = list(map(lambda x: (248, 104, 88), self.colors))
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        #font        = ImageFont.truetype(font='model_data/Times New Roman.ttf', size=np.floor(3e-2 * image.size[1] + 1).astype('int32'))
        font        = ImageFont.truetype(font='model_data/Times New Roman.ttf', size=50)
